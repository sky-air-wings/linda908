...
def build_datasets(
    ...
    faster generation.
    """
    with open("/root/foldingdiff-main/wukevin/foldingdiff_cath/training_args.json") as source:
    ...
    if load_actual:
        ...
        mean_file =Path("/root/foldingdiff-main/wukevin/foldingdiff_cath/training_mean_offset.npy")
...
def main() -> None:
    ...
    args.model = "/root/foldingdiff-main/wukevin/foldingdiff_cath"
